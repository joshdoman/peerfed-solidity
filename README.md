...
A Solidity implementation of the Util protocol. The protocol is currently deployed on the RSK network. An interactive frontend can be found at [https://app.theutil.org](https://app.theutil.org) or built locally using [this repository](https://github.com/joshdoman/util-frontend). Learn more at [https://theutil.org/util.pdf](https://theutil.org/util.pdf)
